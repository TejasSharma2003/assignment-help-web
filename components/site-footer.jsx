            ...
            <footer className="relative bg-light-gradient  z-10 pt-10 dark:bg-dark  ">
                <div className="container">
                    <div className="-mx-4 flex flex-wrap">
                        <div className="sm:w-full px-4 md:w-2/3 w-3/12">
                            <div className="mb-10 w-full">
                                ...
                                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                                    ...
                                    <span>+91-83880 88212</span>
                                </p>
                            </div>
                        </div>

                        <LinkGroup header="Contact Us">
                            <NavLink link="/#" label="+91-83880 88212" />
                            <NavLink link="/#" label="help@assignmentwallah.com" />
                            <NavLink link="/#" label="help.assignmentwallah@gmail.com" />
                        </LinkGroup>
                        <LinkGroup header="Company">
                            <NavLink link="/#" label="About Us" />
                            <NavLink link="/#" label="Contact Us" />
                            <NavLink link="/#" label="Experts" />
                        ...
                        <div className="sm:w-full px-4 lg:w-1/2 w-3/12">
                            <div className="mb-10 w-full">
...
const LinkGroup = ({ children, header }) => {
    return (
        <>
            <div className="sm:w-full px-4 md:w-1/2 w-2/12">
                <div className="mb-10 w-full">
                    <h4 className="mb-9 text-lg font-semibold text-dark dark:text-white">
                        {header}
                    </h4>
...
const NavLink = ({ link, label }) => {
    return (
        <li>
            <a
                href={link}
                className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6 break-all"
            >
                {label}
            </a>
        </li>
