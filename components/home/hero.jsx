...
export default function MarketingPage() {
    return (
        <section className="bg-secondary-dark md:bg-hero-image bg-top lg:min-h-max bg-cover  bg-no-repeat relative before:absolute before:h-full before:w-full before:top-0 before:left-0 md:before:bg-overlay " >
