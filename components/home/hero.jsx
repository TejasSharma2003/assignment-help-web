...
export default function MarketingPage() {
    ...
    return (
        <HeroMain className="relative bg-secondary-dark mb-28 md:pb-40 md:bg-hero-image bg-top lg:min-h-max bg-cover  bg-no-repeat before:absolute before:h-full before:w-full before:top-0 before:left-0 md:before:bg-overlay " >
