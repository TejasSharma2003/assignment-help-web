        ...
        <SectionWrapper>
            ...
            <SideLayout className="md:grid-rows-2 min-[900px]:grid-rows-none lg:py-8">
                ...
                <div className="relative flex flex-col items-center min-[900px]:items-end mt-10">
                    <div className={cn("relative md:max-w-xs w-full  min-[900px]:-translate-y-2/4 bg-white right-0  top-0 rounded-lg  shadow-light  py-5 px-3 flex",classBorder)}> <span className="text-secondary text-[1.2rem]" >01.</span> <div className="ml-5 ">
