        ...
        <div className="">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="flex flex-col rounded-lg px-4 sm:col-span-full py-8 border shadow-light">
                    ...
                    <div className="text-base text-center md:text-left font-medium text-secondary">
                        <span>Students gets their assigment done with the help of assignment wallah experts and we planning do increase our range by accomodating more experts.</span>
                    </div>
                </div>
            </div>
        </div>
