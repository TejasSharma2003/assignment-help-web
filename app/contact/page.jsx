...
export default function ContactPage() {
    return (
        <>
            <HeroMain className="relative bg-secondary-dark mb-56 md:pb-36 md:mb-32">
                ...
                <div className="absolute shadow-light border bg-white w-full left-1/2 -translate-x-1/2 bottom-0 translate-y-1/2 py-10 px-5 max-w-5xl rounded-lg ">
                    <div className="grid gap-8 text-left md:text-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <div className="">
                            <span className="flex justify-center"><MapPin className="stroke-secondary" /></span>
                        ...
                        <div className="">
                            <span className="flex justify-center"><Clock10 className="stroke-secondary" /></span>
                        ...
                        <div className="">
                            <span className="flex justify-center"><Mail className="stroke-secondary" /></span>
